...
[docmark][] utility to combine [extensions][extension].
...
This package can be used to merge multiple extensions into one.

## When should I use this?

This package may be useful when making "presets", such as [`micromark-extension-gfm`][micromark-extension-gfm].
