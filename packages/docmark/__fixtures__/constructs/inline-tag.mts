...
function tokenizeInlineTag(
  ...
  function inlineTagStart(this: void, code: Code): State | undefined {
    ...
    effects.enter(tt.inlineTagMarker, { _open: true })
    effects.consume(code)
    effects.exit(tt.inlineTagMarker)
  ...
  function afterTagName(this: void, code: Code): State | undefined {
    return factorySpace(effects, beforeText, tt.whitespace)(code)
  }
   ...
   *  The next state
   */
  function beforeText(this: void, code: Code): State | undefined {
    if (code === codes.rightCurlyBrace && self.previous !== codes.backslash) {
      effects.enter(tt.inlineTagMarker, { _close: true })
      effects.consume(code)
      effects.exit(tt.inlineTagMarker)
   ...
   * text and result in construct failure.
   *
   * @example
   *  ```markdown
   *  > |@see {@linkcode Code}
   ...
   *  The next state
   */
  function insideText(this: void, code: Code): State | undefined {
    if (code === codes.rightCurlyBrace && self.previous !== codes.backslash) {
    ...
    return effects.consume(code), insideText
  }
}
