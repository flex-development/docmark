/**
 * @file Constructs - text
 * @module docmark/constructs/initialize/text
...
import resolveLineSuffixes from '../../resolvers/line-suffixes.mts'
...
function initializeFactory(
  ...
  function tokenize(this: TokenizeContext, effects: Effects): State {
    ...
    function atBreak(this: void, code: Code): boolean {
       ...
       *
       * @const {Construct | Construct[] | undefined} pack
       */
      const pack: Construct | Construct[] | undefined = constructs[code]
