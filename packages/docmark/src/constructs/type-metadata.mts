 ...
 *
 * @const {NamedConstruct & PartialConstruct} typeMetadata
 */
const typeMetadata: NamedConstruct & PartialConstruct = {
...
function tokenizeTypeMetadata(
  ...
  function typeMetadataStart(this: void, code: Code): State | undefined {
    ...
    // start type metadata.
    effects.enter(tt.typeMetadata)

    // consume opening marker.
    effects.enter(tt.typeMetadataMarker)
  ...
  function beforeTypeExpression(this: void, code: Code): State | undefined {
    ...
    effects.enter(tt.chunkType, {
      contentType: constants.contentTypeType,
      tag: self.containerState.tag
    })
