/**
 * @file Initialize - document
 * @module docmark/initialize/document
...
function tokenizeDocument(this: TokenizeContext, effects: Effects): State {
   ...
   */
  type StackItem = [construct: ContinuableConstruct, state: ContainerState]
   ...
   *
   * @param {number} size
   *  The number of containers to leave open
   * @return {undefined}
   */
  ...
  function writeToChild(
    ...
    // this prevents comment regions from piericing child concrete content.
